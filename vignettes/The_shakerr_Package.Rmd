...
The following functions show how the a timeline may be graphed, with and 
without labels. Note that with labels, the extra parameter indicating the 
top number of earthquakes to label by magnitude.
...
when you click on it. The second will offer more detail.
